...
cv.readImage('/home/pi/webcam/images/2018-07-11T14:38:15.011Z.jpeg', function(err, im) {
  if (err) throw err;
  var width = im.width();
  ...
  big.save('/home/pi/webcam/images/big.png');
  all.save('/home/pi/webcam/images/all.png');
